    ...
    def run(self):
        ...
        while True:
            ...
            if FingerprintThread.MODE == SEARCH:
                ...
                self.f.app.event_generate('<<FINGERPRINT>>', when='tail', state=FingerprintThread.template[0])
                ...
                if sequence == 1:
                    ...
                    self.f.app.event_generate('<<FINGERPRINT>>', when='tail', state=position_number)
