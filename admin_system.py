...
class admin_system(Tk):
    ...
    def registered_user(self, event):
        ...
        if (self.cursor.fetchone() is not None):
            ...
            self.cursor.execute ("INSERT INTO residents_db (LAST_NAME, FIRST_NAME, MIDDLE_NAME, SEX, BIRTH_DATE, CIVIL_STATUS, YEAR_OF_RESIDENCY, ADDRESS, PLACE_OF_BIRTH, SECURITY_QUESTION, ANSWER, Contact_No, IMAGE, RFID) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",(self.last_name, self.first_name,self.middle_name,
                                                                                                                                                                                                                                                                                                self.sex,
                                                                                                                                                                                                                                                                                                self.birth_day,
                                                                                                                                                                                                                                                                                                self.civil_status,
    ...
    def register_admin(self):
        ...
        self.button_submit = Button(self.submit_frame, text = "Submit",bg = "white", command = lambda: self.registered(first_name.get(),
                                                                                                                                  middle_name.get(),
        ...
        if self.p == "":
            ...
            try:
                ...
                if (self.cursor.fetchone() is not None):
                    ...
                    self.cursor.execute ("INSERT INTO residents_admin (LAST_NAME, FIRST_NAME, MIDDLE_NAME, SEX, BIRTH_DATE, CIVIL_STATUS, YEAR_OF_RESIDENCY, ADDRESS, PLACE_OF_BIRTH, Contact_No, IMAGE, USERNAME, PASSWORD) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",(last_name,middle_name,
                                                                                                                                                                                                                                                                                          first_name,
                                                                                                                                                                                                                                                                                          sex,
                                                                                                                                                                                                                                                                                          birth_day,
                                                                                                                                                                                                                                                                                          civil_status,
                    ...
                    self.register_admin_frame.destroy()
                    self.Main_Frame.pack(fill = "both", expand = 1)
            except AttributeError:
                    messagebox.showerror("Error", "Please upload an Image")
